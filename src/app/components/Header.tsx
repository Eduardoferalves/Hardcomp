    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/50 bg-background/80 backdrop-blur-md">
      <div className="container mx-auto px-6 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 group">
          ...
          <span className="font-bold text-xl tracking-tight">{t('navigation.brand')}</span>
        </Link>
        
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-muted-foreground">
          <a href="#" className="hover:text-foreground transition-colors">{t('navigation.links.features')}</a>
          <a href="#" className="hover:text-foreground transition-colors">{t('navigation.links.architecture')}</a>
          <a href="#" className="hover:text-foreground transition-colors">{t('navigation.links.about')}</a>
        </nav>
        ...
        <div className="flex items-center gap-4">
          ...
          >
            {t('navigation.actions.startBuilding')}
          </Link>
        </div>
      </div>
    </header>
